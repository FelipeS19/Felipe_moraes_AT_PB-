...
const Cotacoes = () => {
  ...
  const addCotacao = async (cotacao) => {
    try {
      ...
      console.error("Não foi possivel adicionar a cotação: ", error);
    }
  };
  ...
  const deleteCotacao = async (id) => {
    try {
      ...
      console.error("Não foi possivel deletar a cotação: ", error);
    }
  };
  ...
  const saveEditing = async (cotacao) => {
    try {
      ...
      console.error("Não foi possivel editar a cotação ", error);
    }
  };
